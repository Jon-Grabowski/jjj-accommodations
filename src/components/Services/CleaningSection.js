                    ...
                    <div style={{maxWidth: '40rem'}}>
                        <div className='text-start'>
                            <div className='d-flex align-items-center'>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill='currentColor' height="40" viewBox="0 -960 960 960" width="40" className='ms-3'>
                        ...
                        <div className='text-start'>
                            ...
                            <h4 className='border-bottom d-inline pb-1 pe-2'>Move-In/Move-Out</h4>
                                <svg xmlns="http://www.w3.org/2000/svg" fill='currentColor' height="40" viewBox="0 -960 960 960" width="44" className='ms-3'>
