...
function RentalSection() {
    ...
    return (    
        <div id='rental-section-wrapper' >
                <h1 className='display-2 fw-bold fst-italic mb-5 py-4 bg-black bg-opacity-25'>Rental Property Management</h1>
                <div className='container-lg row m-auto align-items-center'>
                    <div className='col-md-7 d-flex'>
                        <div id='rentals-text' className='m-auto d-flex flex-column justify-content-center gap-3 align-items-center'>
                            <span className='w-100 fs-4 fw-bold mb-3'>Whether you're a property owner looking to maximize your rental income or a traveler seeking the perfect vacation spot, we've got you covered.</span>
